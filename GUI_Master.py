...
#
label_l1 = tk.Label(root, text="Power Point Detection",font=("times", 35, 'bold'),
...
button2 = tk.Button(root, text="PPt Presentation",command=reg,width=18, height=1,font=('times', 20, ' bold '), bg="#0000A0", fg="white")
